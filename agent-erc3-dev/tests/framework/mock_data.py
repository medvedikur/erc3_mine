...
BASE_EMPLOYEES = [
    MockEmployee(
        ...
        manager=None,
        direct_reports=["marko_petrovic", "sofia_rinaldi"],  # CTO and COO report to CEO per Wiki
    ...
    MockEmployee(
        ...
        manager="sofia_rinaldi",  # Reports to COO per Wiki
        direct_reports=[],  # Level 3 - no direct reports per Wiki
        notes="Operations Coordinator",  # Per Wiki hierarchy.md
    ...
    MockEmployee(
        ...
        manager="marko_petrovic",  # Reports to CTO per Wiki
        direct_reports=["felix_baum", "ana_kovac"],  # AI team reports to Lead AI
        notes="Lead AI Engineer",  # Per Wiki hierarchy.md Level 2
    ...
    MockEmployee(
        ...
        manager="lukas_brenner",  # Reports to Lead AI Engineer per Wiki
        direct_reports=[],
        notes="AI Engineer",  # Per Wiki hierarchy.md Level 3
    ...
    MockEmployee(
        ...
        salary=90000,
        location="Munich",
        department="Consulting",  # Per Wiki - Lead Consultant
        manager="sofia_rinaldi",  # Reports to COO per Wiki
        direct_reports=["helene_stutz"],  # Helene reports to Jonas per Wiki
        notes="Lead Consultant",  # Per Wiki hierarchy.md Level 2
        skills=[{"name": "consulting", "level": 4}, {"name": "workshop_facilitation", "level": 4}],
        wills=[],
    ),
    MockEmployee(
        id="helene_stutz",
        ...
        manager="jonas_weiss",  # Reports to Lead Consultant per Wiki
        direct_reports=[],
        notes="Consultant / Analyst",  # Per Wiki hierarchy.md Level 3
    ...
    MockEmployee(
        ...
        department="Software Engineering",
        manager="marko_petrovic",  # Reports to CTO per Wiki
        direct_reports=["timo_van_dijk", "mira_schaefer"],  # SW team reports to Lead SW
        notes="Lead Software Engineer",  # Per Wiki hierarchy.md Level 2
        skills=[{"name": "architecture", "level": 4}, {"name": "software_engineering", "level": 5}],
        wills=[],
    ),
    MockEmployee(
        id="ana_kovac",
        ...
        location="Vienna",
        department="Software Engineering",
        manager="lukas_brenner",  # Reports to Lead AI per Wiki
        direct_reports=[],
        notes="Senior AI Engineer",  # Per Wiki hierarchy.md Level 3
    ...
    MockEmployee(
        ...
        salary=160000,  # CTO salary
        location="Vienna",
        department="Executive",  # Level 1 per Wiki
        manager="elena_vogel",  # CTO reports to CEO
        direct_reports=["lukas_brenner", "klara_houtman"],  # Tech leads report to CTO
        notes="CTO",  # Per Wiki hierarchy.md Level 1
        skills=[{"name": "architecture", "level": 5}, {"name": "system_design", "level": 5}],
        wills=[],
    ),
    MockEmployee(
        id="sofia_rinaldi",
        ...
        salary=145000,  # COO salary
        location="Munich",
        department="Executive",  # Level 1 per Wiki
        manager="elena_vogel",  # COO reports to CEO
        direct_reports=["jonas_weiss", "richard_klein"],  # Per Wiki hierarchy
        notes="COO",  # Per Wiki hierarchy.md Level 1
        skills=[{"name": "operations", "level": 5}, {"name": "finance", "level": 4}],
        wills=[],
    ),
    MockEmployee(
        id="timo_van_dijk",
    ...
    MockEmployee(
        ...
        location="Munich",
        department="Software Engineering",
        manager="klara_houtman",  # Reports to Lead SW per Wiki
        direct_reports=[],
        notes="Software Engineer",  # Per Wiki hierarchy.md Level 3
